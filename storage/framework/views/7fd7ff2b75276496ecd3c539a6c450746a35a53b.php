            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0"><?php echo e(__('Edit Category')); ?></h5>
                        <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('categories.update', $category->id)); ?>" id="categoryForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mb-4">
                                    <label for="name" class="form-label">
                                        <strong><?php echo e(__('Category Name')); ?> <span class="text-danger">*</span></strong>
                                    </label>
...
unset($__errorArgs, $__bag); ?>
                                    <small class="form-text text-muted">
                                        <?php echo e(__('Enter the name of the category (e.g., Electronics, Clothing, Furniture)')); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              rows="5" 
                                              placeholder="Enter category description (optional)"><?php echo e(old('description', $category->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    <small class="form-text text-muted">
                                        <?php echo e(__('Describe the category, types of products, etc.')); ?>
                                ...
                                <div class="form-group mb-4">
                                    <label class="form-label">
                                        <strong><?php echo e(__('Additional Information')); ?></strong>
                                    </label>
                                ...
                                <div class="form-group mt-5">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-secondary px-4 me-2">
                                                <i class="ti ti-x me-1"></i> <?php echo e(__('Cancel')); ?>

                                            </a>
                                            <?php if(\Auth::user()->can('item_category_delete')): ?>
                                        ...
                                        <button type="submit" class="btn btn-primary px-4">
                                            <i class="ti ti-check me-1"></i> <?php echo e(__('Update Category')); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel"><?php echo e(__('Delete Category')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p><?php echo e(__('Are you sure you want to delete this category?')); ?></p>
                    ...
                    <?php if($itemCount > 0): ?>
                        <div class="alert alert-warning mt-3">
                            ...
                            <?php echo e(__('This category is being used in :count items. You cannot delete it until you remove or reassign these items.', ['count' => $itemCount])); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Projects\savantec-erp\resources\views/categories/edit.blade.php ENDPATH**/ ?>