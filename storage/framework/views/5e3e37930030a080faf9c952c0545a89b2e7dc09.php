...
<?php if(!empty($user) && $user->count() > 0): ?>
    ...
    <?php if($get == 'all_members'): ?>
        <table class="messenger-l ist-item" data-contact="<?php echo e($user->id); ?>">
            <tr data-action="0">
...
<?php /**PATH C:\Users\ADMIN\Projects\savantec-project\resources\views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>