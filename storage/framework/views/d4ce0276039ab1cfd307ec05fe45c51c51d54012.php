            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="card-title mb-0"><?php echo e(__('Add/Update Items')); ?></h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('items.store')); ?>" id="itemForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" required 
                                           placeholder="Enter item name" value="<?php echo e(old('name')); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="item_group" name="item_group" required>
                                        ...
                                        <option value="single" <?php echo e(old('item_group') == 'single' ? 'selected' : 'selected'); ?>><?php echo e(__('Single')); ?></option>
                                        <option value="variants" <?php echo e(old('item_group') == 'variants' ? 'selected' : ''); ?>><?php echo e(__('Variants')); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hsn" name="hsn" 
                                           placeholder="Enter HSN code" value="<?php echo e(old('hsn')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="barcode" name="barcode" 
                                           placeholder="Enter barcode" value="<?php echo e(old('barcode')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sku" name="sku" 
                                           placeholder="Enter SKU" value="<?php echo e(old('sku')); ?>">
                                    <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="brand" name="brand">
                                        ...
                                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brandName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($brandName); ?>" <?php echo e(old('brand') == $brandName ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="category" name="category">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $categoryName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($categoryName); ?>" <?php echo e(old('category') == $categoryName ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="company_id" name="company_id" required>
                                        ...
                                        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $companyName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>" <?php echo e(old('company_id') == $id ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="unit" name="unit">
                                        ...
                                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $unitName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(old('unit') == $key ? 'selected' : ''); ?>>
                                                <?php echo e($unitName); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control text-end" id="alert_quantity" 
                                           ...
                                           value="<?php echo e(old('alert_quantity', 0)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control text-end" id="opening_stock" 
                                           ...
                                           value="<?php echo e(old('opening_stock', 0)); ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" 
                                              rows="3" placeholder="Enter item description"><?php echo e(old('description')); ?></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control text-end" id="price" 
                                               ...
                                               required value="<?php echo e(old('price', 0)); ?>">
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control text-end" id="seller_points" 
                                           ...
                                           value="<?php echo e(old('seller_points', 0)); ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="discount_type" name="discount_type">
                                        <option value="percentage" <?php echo e(old('discount_type') == 'percentage' ? 'selected' : 'selected'); ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="tax_type" name="tax_type" required>
                                        <option value=""><?php echo e(__('-Select-')); ?></option>
                                        <option value="inclusive" <?php echo e(old('tax_type') == 'inclusive' ? 'selected' : 'selected'); ?>>
                                            <?php echo e(__('Inclusive')); ?>

                                        </option>
                                        <option value="exclusive" <?php echo e(old('tax_type') == 'exclusive' ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="tax_id" name="tax_id">
                                        ...
                                        <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <option value="<?php echo e($tax->id); ?>" <?php echo e(old('tax_id') == $tax->id ? 'selected' : ''); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control text-end" id="purchase_price" 
                                               ...
                                               required value="<?php echo e(old('purchase_price', 0)); ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control text-end" id="sales_price" 
                                               ...
                                               required value="<?php echo e(old('sales_price', 0)); ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control text-end" id="profit_margin" 
                                               ...
                                               value="<?php echo e(old('profit_margin', 0)); ?>">
                                        <span class="input-group-text">%</span>
                                    </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12 text-center">
                                ...
                                <button type="button" class="btn btn-outline-secondary btn-lg px-5" onclick="window.history.back()">
                                    <i class="fas fa-times"></i> <?php echo e(__('Close')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Projects\savantec-github\resources\views/items/create.blade.php ENDPATH**/ ?>