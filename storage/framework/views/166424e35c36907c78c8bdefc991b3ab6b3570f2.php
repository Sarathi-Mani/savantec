...
<?php $__env->startSection('content'); ?>
    ...
    <table class="table w-100 " id="userTable">
        <thead>
            <tr>
                <th class="text-center"><?php echo e(__('#')); ?></th> <!-- Change from S.No to # -->
                <?php if($isSuperAdmin || $isCompanyAdmin): ?>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <?php if($isSuperAdmin || $isCompanyAdmin): ?>
                        <td>
                            ...
                            <?php if(!empty($companyNames)): ?>
                                <?php echo e(implode(', ', $companyNames)); ?>
                    ...
                    <td>
                        <?php echo e(!empty($user->created_at) ? $user->created_at->format('Y-m-d') : '-'); ?>
...
$(document).ready(function() {
    // Initialize when DataTable is ready
    var initTable = function() {
        var table = $('#userTable').DataTable({
            "order": [[6, "desc"]], // Order by Created On column (index 6) descending
            "stateSave": false, // Don't save state to override default ordering
            "columnDefs": [
                {
                ...
                {
                    "targets": 6, // Created On column
                    "type": "date", // Treat as date for proper sorting
                    "orderable": true,
                    "searchable": true
                },
                {
    ...
    if ($.fn.DataTable.isDataTable('#userTable')) {
        ...
        // If not initialized yet, wait for x-export-scripts to initialize it
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Projects\savantec-github\resources\views/user/index.blade.php ENDPATH**/ ?>