...
<?php $__env->startPush('script-page'); ?>
    <script>
        <?php if(\Auth::user()->can('show account dashboard') || \Auth::user()->type == 'company'): ?>
        (function () {
            var chartBarOptions = {
                series: [
                    {
            ...
            var cashFlowElement = document.querySelector("#cash-flow");
            if(cashFlowElement) {
                var arChart = new ApexCharts(cashFlowElement, chartBarOptions);
                arChart.render();
            }
        })();
        ...
        (function () {
            ...
            var incExpElement = document.querySelector("#incExpBarChart");
            if(incExpElement) {
                var chart = new ApexCharts(incExpElement, options);
                chart.render();
            }
        })();
        ...
        (function () {
            ...
            var expenseElement = document.querySelector("#expenseByCategory");
            if(expenseElement) {
                var chart = new ApexCharts(expenseElement, options);
                chart.render();
            }
        })();
        ...
        (function () {
            ...
            var incomeElement = document.querySelector("#incomeByCategory");
            if(incomeElement) {
                var chart = new ApexCharts(incomeElement, options);
                chart.render();
            }
        })();
        ...
        (function () {
            ...
            var limitElement = document.querySelector("#limit-chart");
            if(limitElement) {
                var chart = new ApexCharts(limitElement, options);
                chart.render();
            }
        })();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Projects\savantec-project\resources\views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>