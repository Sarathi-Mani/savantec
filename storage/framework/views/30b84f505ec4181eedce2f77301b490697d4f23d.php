    ...
    <div class="footer-wrapper">
        <div class="py-1">
            <p class="mb-0 text-muted"> &copy;
                <?php echo e(date('Y')); ?> <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'SellfizERP')); ?>
...
<script>
    // Stop Choices.js from auto-initializing select2 elements
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.select2').forEach(function (el) {
            // Remove Choices wrapper if applied
...
<?php /**PATH C:\Users\ADMIN\Projects\savantec-project\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>