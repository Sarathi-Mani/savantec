...
<?php endif; ?>
    <div class="navbar-wrapper" style="height: 100vh; display: flex; flex-direction: column; overflow: hidden;">
            ...
            <a href="#" class="b-brand">
                <?php if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on'): ?>
                    <img src="<?php echo e($logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png')); ?>"
                         alt="<?php echo e(config('app.name', 'SellfizERP')); ?>" class="logo logo-lg">
                <?php else: ?>
        ...
        <div class="navbar-content" style="flex: 1; overflow-y: auto; overflow-x: hidden;">
            <?php if(\Auth::user()->type != 'client'): ?>
                <ul class="dash-navbar">
                    ...
                    <?php if(Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard') || Gate::check('show crm dashboard') || Gate::check('show pos dashboard')): ?>
                        ...
                        ?>
                        <li class="dash-item dash-hasmenu <?php echo e($dashboardActive ? 'active dash-trigger' : ''); ?>">
                            ...
                            <ul class="dash-submenu">
                                <?php if(\Auth::user()->show_account() == 1 && Gate::check('show account dashboard')): ?>
                                    ...
                                    ?>
                                    <li class="dash-item dash-hasmenu <?php echo e($accountActive ? 'active dash-trigger' : ''); ?>">
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            <?php if(Gate::check('income report') || Gate::check('expense report') || Gate::check('income vs expense report') ||
                                                ...
                                                Gate::check('bill report') || Gate::check('stock report') || Gate::check('manage transaction') || Gate::check('statement report')): ?>
                                ...
                                <?php if(\Auth::user()->show_hrm() == 1): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show hrm dashboard')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($hrmActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('HRM')); ?>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage report')): ?>
                                                    ...
                                                    ?>
                                                    <li class="dash-item dash-hasmenu <?php echo e($hrmReportsActive ? 'active dash-trigger' : ''); ?>">
                                                        <a class="dash-link" href="#">
                                                            <?php echo e(__('Reports')); ?>
                                ...
                                <?php if(\Auth::user()->show_crm() == 1): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show crm dashboard')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($crmActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('CRM')); ?>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                ?>
                                                <li class="dash-item dash-hasmenu <?php echo e($crmReportsActive ? 'active dash-trigger' : ''); ?>">
                                                    <a class="dash-link" href="#">
                                                        <?php echo e(__('Reports')); ?>
                                ...
                                <?php if(\Auth::user()->show_pos() == 1): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show pos dashboard')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($posActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('POS')); ?>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                ?>
                                                <li class="dash-item dash-hasmenu <?php echo e($posReportsActive ? 'active dash-trigger' : ''); ?>">
                                                    <a class="dash-link" href="#">
                                                        <?php echo e(__('Reports')); ?>
                    ...
                    <?php if(\Auth::user()->type != 'super admin' && (Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage client'))): ?>
                        ...
                        ?>
                        <li class="dash-item dash-hasmenu <?php echo e($userManagementActive ? 'active dash-trigger' : ''); ?>">
                            <a href="#!" class="dash-link">
                                <span class="dash-micon">
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage client')): ?>
                                    <li class="dash-item <?php echo e((Request::route()->getName() == 'company.index' || Request::segment(1) == 'company' || Request::route()->getName() == 'clients.edit') ? 'active' : ''); ?>">
                                        <a class="dash-link" href="<?php echo e(route('company.index')); ?>"><?php echo e(__('Company')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    <!--------------------- Start Report ----------------------------------->
                    <?php if(\Auth::user()->show_report() == 1): ?>
                        <?php if(Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                            ...
                            ?>
                            <li class="dash-item dash-hasmenu <?php echo e($reportActive ? 'active dash-trigger' : ''); ?>">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                ...
                                <ul class="dash-submenu">
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'enquiry') ? 'active dash-trigger' : ''); ?>">
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('enquiry.index')); ?>" class="dash-link">
                                                <?php echo e(__('Enquiry Report')); ?>
                                    ...
                                    <?php if(Gate::check('manage set salary') || Gate::check('manage pay slip')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($payrollActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('Payroll Setup')); ?>
                                    ...
                                    <?php if(Gate::check('manage leave') || Gate::check('manage attendance')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($leaveActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('Leave Management Setup')); ?>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage attendance')): ?>
                                                    <?php
                                                        $attendanceActive = (Request::segment(1) == 'attendanceemployee');
                                                    ?>
                                                    <li class="dash-item dash-hasmenu <?php echo e($attendanceActive ? 'active dash-trigger' : ''); ?>">
                                                        <a class="dash-link" href="#">
                    ...
                    <?php if(\Auth::user()->show_hrm() == 1): ?>
                        <?php if(Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                            ...
                            ?>
                            <li class="dash-item dash-hasmenu <?php echo e($hrmSystemActive ? 'active dash-trigger' : ''); ?>">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                        <i class="ti ti-user"></i>
                                    </span>
                                    <span class="dash-mtext"><?php echo e(__('HRM System')); ?></span>
                                    <span class="dash-arrow">
                                        <i data-feather="chevron-right"></i>
                                    </span>
                                </a>
                                <ul class="dash-submenu">
                                    ...
                                    <?php if(Gate::check('manage set salary') || Gate::check('manage pay slip')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($hrmPayrollActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('Payroll Setup')); ?>
                                    ...
                                    <?php if(Gate::check('manage leave') || Gate::check('manage attendance')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($hrmLeaveActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('Leave Management Setup')); ?>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage attendance')): ?>
                                                    <?php
                                                        $hrmAttendanceActive = (Request::segment(1) == 'attendanceemployee');
                                                    ?>
                                                    <li class="dash-item dash-hasmenu <?php echo e($hrmAttendanceActive ? 'active dash-trigger' : ''); ?>">
                                                        <a class="dash-link" href="#">
                                                            <?php echo e(__('Attendance')); ?>
                                    ...
                                    <?php if(Gate::check('manage indicator') || Gate::check('manage appraisal') || Gate::check('manage goal tracking')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($performanceActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('Performance Setup')); ?>
                                    ...
                                    <?php if(Gate::check('manage training') || Gate::check('manage trainer') || Gate::check('show training')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($trainingActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('Training Setup')); ?>
                                    ...
                                    <?php if(Gate::check('manage job') || Gate::check('create job') || Gate::check('manage job application') || Gate::check('manage custom question') || Gate::check('show interview schedule') || Gate::check('show career')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($recruitmentActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('Recruitment Setup')); ?>
                                            ...
                                            <ul class="dash-submenu">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage job')): ?>
                                                    <?php
                                                        $jobActive = (
                                                            Request::route()->getName() == 'job.index' || 
                                                            Request::route()->getName() == 'job.create' || 
                                                            Request::route()->getName() == 'job.edit' || 
                                                            Request::route()->getName() == 'job.show'
                                                        );
                                                    ?>
                                                    <li class="dash-item <?php echo e($jobActive ? 'active' : ''); ?>">
                                    ...
                                    <?php if(Gate::check('manage award') || Gate::check('manage transfer') || Gate::check('manage resignation') || Gate::check('manage travel') || Gate::check('manage promotion') || Gate::check('manage complaint') || Gate::check('manage warning') || Gate::check('manage termination') || Gate::check('manage announcement') || Gate::check('manage holiday')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($hrAdminActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                                <?php echo e(__('HR Admin Setup')); ?>
                                    ...
                                    <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'HR'): ?>
                                        ...
                                        ?>
                                        <li class="dash-item <?php echo e($hrmSetupActive ? 'active dash-trigger' : ''); ?>">
                    ...
                    <!--------------------- Start Quotation System ----------------------------------->
                    <?php
                        $quotationActive = (
                            Request::segment(1) == 'quotation' || 
                            Request::segment(1) == 'quotations'
                        );
                    ?>
                    <li class="dash-item dash-hasmenu <?php echo e($quotationActive ? 'active dash-trigger' : ''); ?>">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon">
                                <i class="ti ti-file-invoice"></i>
                            </span>
                            <span class="dash-mtext"><?php echo e(__('Quotation System')); ?></span>
                            <span class="dash-arrow">
                                <i data-feather="chevron-right"></i>
                            </span>
                        </a>
                        <ul class="dash-submenu">
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'quotation.create') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('quotation.create')); ?>">
                                    <?php echo e(__('Add Quotation')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'quotation.index' || Request::segment(1) == 'quotations') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('quotation.index')); ?>">
                                    <?php echo e(__('Quotation List')); ?>

                                </a>
                            </li>
                        </ul>
                    </li>
                    <!--------------------- End Quotation System ----------------------------------->

                    <!--------------------- Start Items Management System ----------------------------------->
                    <?php
                        $itemsActive = (
                            Request::segment(1) == 'items' || 
                            Request::segment(1) == 'item'
                        );
                    ?>
                    <li class="dash-item dash-hasmenu <?php echo e($itemsActive ? 'active dash-trigger' : ''); ?>">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon">
                                <i class="ti ti-package"></i>
                            </span>
                            <span class="dash-mtext"><?php echo e(__('Items Management')); ?></span>
                            <span class="dash-arrow">
                                <i data-feather="chevron-right"></i>
                            </span>
                        </a>
                        <ul class="dash-submenu">
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'items.create') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('items.create')); ?>">
                                    <i class="ti ti-plus me-2"></i>
                                    <?php echo e(__('Add Items')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'items.index' || Request::segment(1) == 'items') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('items.index')); ?>">
                                    <i class="ti ti-list me-2"></i>
                                    <?php echo e(__('Items List')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'brands.create') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('brands.create')); ?>">
                                    <i class="ti ti-plus me-2"></i>
                                    <?php echo e(__('Add Brand')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'brands.index' || Request::segment(1) == 'brands') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('brands.index')); ?>">
                                    <i class="ti ti-list me-2"></i>
                                    <?php echo e(__('Brand List')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'categories.create') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('categories.create')); ?>">
                                    <i class="ti ti-plus me-2"></i>
                                    <?php echo e(__('Add Category')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'categories.index' || Request::segment(1) == 'categories') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('categories.index')); ?>">
                                    <i class="ti ti-list me-2"></i>
                                    <?php echo e(__('Category List')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'item-variants.create') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('item-variants.create')); ?>">
                                    <i class="ti ti-plus me-2"></i>
                                    <?php echo e(__('Add Variant')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'item-variants.index' || Request::segment(1) == 'item-variants') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('item-variants.index')); ?>">
                                    <i class="ti ti-list me-2"></i>
                                    <?php echo e(__('Variants List')); ?>

                                </a>
                            </li>
                        </ul>
                    </li>
                    <!--------------------- End Items Management System ----------------------------------->

                    <!--------------------- Start Account ----------------------------------->
                    <?php if(\Auth::user()->show_account() == 1): ?>
                        <?php if(Gate::check('manage customer') || Gate::check('manage vender') || Gate::check('manage proposal') || Gate::check('manage bank account') || Gate::check('manage bank transfer') || Gate::check('manage invoice') || Gate::check('manage revenue') || Gate::check('manage credit note') || Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note') || Gate::check('manage chart of account') || Gate::check('manage journal entry') || Gate::check('balance sheet report') || Gate::check('ledger report') || Gate::check('trial balance report')): ?>
                            <?php
                                $accountingActive = (
                                    ...
                                    (Request::segment(1) == 'transaction' && Request::segment(2) != 'ledger' && Request::segment(2) != 'balance-sheet' && Request::segment(2) != 'trial-balance') || 
                            ...
                            ?>
                            <li class="dash-item dash-hasmenu <?php echo e($accountingActive ? 'active dash-trigger' : ''); ?>">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                        <i class="ti ti-box"></i>
                                    </span>
                                    <span class="dash-mtext"><?php echo e(__('Accounting System')); ?></span>
                                    <span class="dash-arrow">
                                        <i data-feather="chevron-right"></i>
                                    </span>
                                </a>
                                <ul class="dash-submenu">
                                    ...
                                    <?php if(Gate::check('manage bank account') || Gate::check('manage bank transfer')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($bankingActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                    ...
                                    <?php if(Gate::check('manage invoice') || Gate::check('manage revenue') || Gate::check('manage credit note')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($incomeActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                    ...
                                    <?php if(Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($expenseActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                    ...
                                    <?php if(Gate::check('manage chart of account') || Gate::check('manage journal entry') || Gate::check('balance sheet report') || Gate::check('ledger report') || Gate::check('trial balance report')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($doubleEntryActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                                    ...
                                    <?php if(Gate::check('manage constant tax') || Gate::check('manage constant category') || Gate::check('manage constant unit') || Gate::check('manage constant payment method') || Gate::check('manage constant custom field')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item <?php echo e($accountingSetupActive ? 'active dash-trigger' : ''); ?>">
                    ...
                    <?php if(\Auth::user()->show_crm() == 1): ?>
                        <?php if(Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder') || Gate::check('manage contract')): ?>
                            ...
                            ?>
                            <li class="dash-item dash-hasmenu <?php echo e($crmSystemActive ? 'active dash-trigger' : ''); ?>">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <?php if(Gate::check('manage lead stage') || Gate::check('manage pipeline') || Gate::check('manage source') || Gate::check('manage label') || Gate::check('manage stage')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item <?php echo e($crmSetupActive ? 'active dash-trigger' : ''); ?>">
                    ...
                    <?php if(\Auth::user()->show_project() == 1): ?>
                        <?php if(Gate::check('manage project')): ?>
                            ...
                            ?>
                            <li class="dash-item dash-hasmenu <?php echo e($projectSystemActive ? 'active dash-trigger' : ''); ?>">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                ...
                                <ul class="dash-submenu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project')): ?>
                                        <?php
                                            $projectActive = (
                                                Request::segment(1) == 'project' || 
                                                Request::route()->getName() == 'projects.list' || 
                                                Request::route()->getName() == 'projects.index' || 
                                                Request::route()->getName() == 'projects.show' || 
                                                request()->is('projects/*')
                                            );
                                        ?>
                                        <li class="dash-item <?php echo e($projectActive ? 'active' : ''); ?>">
                                    ...
                                    <?php if(Gate::check('manage project task stage') || Gate::check('manage bug status')): ?>
                                        ...
                                        ?>
                                        <li class="dash-item dash-hasmenu <?php echo e($projectSetupActive ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#">
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                <li class="dash-item <?php echo e((Request::segment(1) == 'productservice') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('productservice.index')); ?>" class="dash-link"><?php echo e(__('Product & Services')); ?></a>
                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'productstock') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('productstock.index')); ?>" class="dash-link"><?php echo e(__('Product Stock')); ?></a>
                                </li>
                            </ul>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if(\Auth::user()->show_pos() == 1): ?>
                        <?php if(Gate::check('manage warehouse') || Gate::check('manage purchase') || Gate::check('manage pos') || Gate::check('manage print settings')): ?>
                            ...
                            ?>
                            <li class="dash-item dash-hasmenu <?php echo e($posSystemActive ? 'active dash-trigger' : ''); ?>">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                        <i class="ti ti-layers-difference"></i>
                                    </span>
                    ...
                    <?php if(\Auth::user()->type != 'super admin'): ?>
                        <?php if(Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage company settings')): ?>
                            ...
                            ?>
                            <li class="dash-item dash-hasmenu <?php echo e($settingsActive ? 'active dash-trigger' : ''); ?>">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
...
</nav><?php /**PATH C:\Users\ADMIN\Projects\savantec-project\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>