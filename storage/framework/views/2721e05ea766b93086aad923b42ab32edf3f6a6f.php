            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0"><?php echo e(__('Add New Category')); ?></h5>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('categories.store')); ?>" id="categoryForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mt-5">
                                    <div class="d-flex justify-content-between">
                                        <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-secondary px-4">
                                            <i class="ti ti-x me-1"></i> <?php echo e(__('Cancel')); ?>

                                        </a>
                                        <button type="submit" class="btn btn-primary px-4">
                                            <i class="ti ti-check me-1"></i> <?php echo e(__('Create Category')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Projects\savantec-github\resources\views/categories/create.blade.php ENDPATH**/ ?>