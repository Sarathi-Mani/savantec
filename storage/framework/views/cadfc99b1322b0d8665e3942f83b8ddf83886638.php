...
<?php endif; ?>
                ...
                <ul class="dash-navbar">
                    ...
                    <?php if(\Auth::user()->show_report() == 1): ?>
                        <?php if( Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'reports' || Request::segment(1) == 'roles'
                            || Request::segment(1) == 'clients'  || Request::segment(1) == 'userlogs')?' active dash-trigger':''); ?>">
                        ...
                        <?php if( Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'holiday-calender'
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'leavetype' || Request::segment(1) == 'document' || Request::segment(1) == 'performanceType'
    ...
    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'quotation' || Request::segment(1) == 'quotations') ? 'active dash-trigger' : ''); ?>">
        <a href="#!" class="dash-link">
            <span class="dash-micon">
...
<li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'items' || Request::segment(1) == 'item') ? 'active dash-trigger' : ''); ?>">
    <a href="#!" class="dash-link">
        <span class="dash-micon">
...
<!--------------------- End Items Management System ----------------------------------->
                    ...
                    <?php if(\Auth::user()->show_pos() == 1): ?>
                        ...
                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show')?' active dash-trigger':''); ?>">
                            ...
                            <ul class="dash-submenu <?php echo e((Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase'
                                                    || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print'
                                                    || Request::route()->getName() == 'pos.show')?'show':''); ?>">
                    ...
                    <?php if((\Auth::user()->type != 'super admin')): ?>
                        <?php if( Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage company settings')): ?>
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'settings' || Request::segment(1) == 'plans'
...
<?php /**PATH C:\Users\ADMIN\Projects\savantec-erp\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>