            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="items-table">
                    <thead class='mt-5'>
                        <tr>
                            <th style="width: 5%;">#</th>
                            <th style="width: 20%;"><?php echo e(__('Item Name')); ?></th>
                            <th style="width: 10%;"><?php echo e(__('Qty')); ?></th>
                            <th style="width: 25%;"><?php echo e(__('Description')); ?></th>
                            <th style="width: 15%;"><?php echo e(__('Suitable Item')); ?></th>
                            <?php if($status == 'ready_for_purchase' || $status == 'ready_for_quotation'): ?>
                                <th style="width: 10%;"><?php echo e(__('Purchase Price')); ?></th>
                                <th style="width: 10%;"><?php echo e(__('Sales Price')); ?></th>
                            <?php endif; ?>
                            <th style="width: 10%;"><?php echo e(__('Item Image')); ?></th>
                            ...
                            <?php $__currentLoopData = $enquiryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr data-item-index="<?php echo e($currentItemIndex); ?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="item-name-display" id="item_name_display_<?php echo e($currentItemIndex); ?>">
                                            <?php echo e($itemName ?: 'No item selected'); ?>
                                        ...
                                        <?php else: ?>
                                            <input type="hidden" class="item-name-input" 
                                                   ...
                                                   value="">
                                            <input type="hidden" 
                                                   name="items[<?php echo e($currentItemIndex); ?>][custom_item]" 
                                                   value="<?php echo e($itemName); ?>">
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <!-- Qty Display (Regular Column) -->
                                        <div class="qty-display" id="qty_display_<?php echo e($currentItemIndex); ?>">
                                            <?php echo e($item['quantity'] ?? 1); ?>

                                        </div>
                                        <input type="hidden" class="qty-input" 
                                               name="items[<?php echo e($currentItemIndex); ?>][quantity]" 
                                               value="<?php echo e($item['quantity'] ?? 1); ?>">
                                    </td>
                                    <td>
                                        <!-- Description Display (Regular Column - NO INPUT BOX) -->
                                        <div class="item-description-display" id="item_description_display_<?php echo e($currentItemIndex); ?>">
                                            <?php echo e($itemDescription ?: 'No description'); ?>

                                        </div>
                                        <input type="hidden" class="item-description-input" 
                                               name="items[<?php echo e($currentItemIndex); ?>][description]" 
                                               value="<?php echo e($itemDescription); ?>">
                                    </td>
                                    <td>
                                        <!-- Suitable Item Input Box -->
                                        <input type="text" class="form-control form-control-sm" 
                                               name="items[<?php echo e($currentItemIndex); ?>][suitable_item]" 
                                               value="<?php echo e(old('items.' . $currentItemIndex . '.suitable_item', $item['suitable_item'] ?? '')); ?>"
                                               placeholder="<?php echo e(__('Enter suitable item...')); ?>">
                                    </td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <input type="hidden" class="purchase-price" 
                                               name="items[<?php echo e($currentItemIndex); ?>][purchase_price]" 
                                               value="<?php echo e($item['purchase_price'] ?? '0.00'); ?>">
                                        <input type="hidden" class="sales-price" 
                                               name="items[<?php echo e($currentItemIndex); ?>][sales_price]" 
                                               value="<?php echo e($item['sales_price'] ?? '0.00'); ?>">
                                    <?php endif; ?>
                                    
                                    <td>
                                        <!-- Image Preview -->
                                        <div class="item-image-container text-center">
                                            <?php if($itemImage && $imageFound): ?>
                                                ...
                                                <input type="hidden" 
                                                       name="items[<?php echo e($currentItemIndex); ?>][existing_image]" 
                                                       value="<?php echo e($itemImage); ?>">
                                            <?php elseif($itemImage && !$imageFound): ?>
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6 purchase-remarks-section" id="pending-remarks-section">
                <?php if($status == 'ready_for_purchase'): ?>
                    <div class="form-group">
                ...
                <?php elseif($status == 'ready_for_quotation'): ?>
                    <div class="form-group">
                        <label for="pending_remarks" class="form-label"><?php echo e(__('Pending Remarks')); ?></label>
                        <div class="form-control-plaintext bg-light p-2 rounded" style="min-height: 80px;">
                            <?php echo e(old('pending_remarks', $enquiry->pending_remarks) ?: 'No pending remarks'); ?>
    ...
    $(document).ready(function() {
        ...
        function toggleStatusBasedUI() {
            ...
            if (status === 'ready_for_purchase') {
                ...
                pendingRemarksSection.html(`
                    <div class="form-group">
                        <label for="pending_remarks" class="form-label"><?php echo e(__('Pending Remarks')); ?></label>
                        <textarea class="form-control" id="pending_remarks" name="pending_remarks" rows="3" placeholder="<?php echo e(__('Enter pending remarks...')); ?>">${currentValue}</textarea>
                    </div>
                `);
        ...
        function togglePriceColumns(showPrices) {
            ...
            if (showPrices) {
                ...
                if (thead.find('th:nth-child(6)').text() !== '<?php echo e(__('Purchase Price')); ?>') {
                    // Add headers
