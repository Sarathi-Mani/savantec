...
<div class="pos-preview-main"  id="boxes">
    <div class="pos-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
        <table>
            <tbody>
            <tr>
                <td>
                    <img class="pos-logo" src="<?php echo e($img); ?>" alt="">
                </td>
                <td class="text-right">
                ...
                <td>
                    <table class="no-space" style="width: 45%;margin-left: auto;">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo e(Utility::posNumberFormat($settings,$pos->pos_id)); ?></td>
                        </tr>

                        <tr>
                            <td><?php echo e(__('Issue Date')); ?>:</td>
                            <td class="text-right"><?php echo e(Utility::dateFormat($settings,$pos->issue_date)); ?></td>
                        </tr>


                        <?php if(!empty($customFields) && count($pos->customField)>0): ?>
                            <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($field->name); ?> :</td>
                                    <td> <?php echo e(!empty($pos->customField)?$pos->customField[$field->id]:'-'); ?></td>
                                </tr>
                ...
                <?php if(isset($pos->itemData) && count($pos->itemData) > 0): ?>
                    <?php $__currentLoopData = $pos->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e(Utility::priceFormat($settings,$totalTaxPrice)); ?></td>
                            <td><?php echo e(Utility::priceFormat($settings,($item->price*$item->quantity) +$totalTaxPrice)); ?></td>
                ...
                <td colspan="2" class="sub-total">
                    <table class="total-table">
                        <tr>
                            ...
                            <td><?php echo e(Utility::priceFormat($settings,$posPayment->amount)); ?></td>
                        </tr>

                        <tr>
                            <td><?php echo e(__('Discount')); ?>:</td>
                            <?php if(!empty($posPayment->discount)): ?>
                                <td><?php echo e(Utility::priceFormat($settings,$posPayment->discount)); ?></td>
                            <?php else: ?>
                                <td>-</td>
                            <?php endif; ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php if(!empty($posPayment->discount)): ?>
                                <td><?php echo e(Utility::priceFormat($settings,$posPayment->amount - $posPayment->discount)); ?></td>
                            <?php else: ?>
                                <td><?php echo e(Utility::priceFormat($settings,$posPayment->amount )); ?></td>
...
<?php /**PATH C:\WORK GPT\Github repo\savantec-erp\resources\views/pos/templates/template1.blade.php ENDPATH**/ ?>