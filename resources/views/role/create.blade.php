                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_deposit_view">{{__('View Money Deposit')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_deposit_add">{{__('Add Money Deposit ')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_deposit_edit">{{__('Edit Money Deposit')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_deposit_delete">{{__('Delete Money Deposit')}}</label>
                                                            </div>
                                                            <!-- Cash Flow -->
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_cash_flow_view">{{__('View Cash Flow')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_cash_flow_add">{{__('Add Cash Flow')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_cash_flow_edit">{{__('Edit Cash Flow')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_cash_flow_delete">{{__('Delete Cash Flow')}}</label>
                                                            </div>
                                                            <!-- Money Transfer -->
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_transfer_view">{{__('View Money Transfer')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_transfer_add">{{__('Add Money Transfer')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_transfer_edit">{{__('Edit Money Transfer')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_money_transfer_delete">{{__('Delete Money Transfer')}}</label>
                                                            </div>
                                                            <!-- Chart of Accounts -->
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_chart_of_accounts_view">{{__('View Chart of Accounts')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_chart_of_accounts_add">{{__('Add Chart of Accounts')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_chart_of_accounts_edit">{{__('Edit Chart of Accounts')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_chart_of_accounts_delete">{{__('Delete Chart of Accounts')}}</label>
                                                            </div>
                                                            <!-- Entries -->
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_entries_view">{{__('View Entries')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_entries_add">{{__('Add Entries')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_entries_edit">{{__('Edit Entries')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_entries_delete">{{__('Delete Entries')}}</label>
                                                            </div>
                                                            <!-- Cash Transactions -->
                                                            <div class="col-md-4 form-check">
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_expense_item_view">{{__('view Expense Item')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_expense_item_add">{{__('Add Expense Item')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_expense_item_edit">{{__('Edit Expense Item')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_expense_item_delete">{{__('Delete Expense Item')}}</label>
                                                            </div>
                                                            <!-- Special Permission -->
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_show_all_users_expenses">{{__('Show All Users Expenses')}}</label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 form-check">
                                                                ...
                                                                <label class="form-check-label" for="permission_dashboard_chart">{{__('Purchase and Sales Chart')}}</label>
                                                            </div>
                                                            <div class="col-md-4 form-check">
