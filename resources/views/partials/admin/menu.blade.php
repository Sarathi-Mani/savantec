            ...
            <a href="#" class="b-brand">
                @if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on')
                    <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                         alt="{{ config('app.name', 'SellfizERP') }}" class="logo logo-lg">
                @else
            ...
            @if(\Auth::user()->type != 'client')
                <ul class="dash-navbar">
                    ...
                    @if(Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard') || Gate::check('show crm dashboard') || Gate::check('show pos dashboard'))
                        ...
                        @endphp
                        <li class="dash-item dash-hasmenu {{ $dashboardActive ? 'active dash-trigger' : '' }}">
                            ...
                            <ul class="dash-submenu">
                                @if(\Auth::user()->show_account() == 1 && Gate::check('show account dashboard'))
                                    ...
                                    @endphp
                                    <li class="dash-item dash-hasmenu {{ $accountActive ? 'active dash-trigger' : '' }}">
                                ...
                                @if(\Auth::user()->show_hrm() == 1)
                                    @can('show hrm dashboard')
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $hrmActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('HRM') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                @can('manage report')
                                                    ...
                                                    @endphp
                                                    <li class="dash-item dash-hasmenu {{ $hrmReportsActive ? 'active dash-trigger' : '' }}">
                                                        <a class="dash-link" href="#">
                                                            {{ __('Reports') }}
                                                            <span class="dash-arrow">
                                                                <i data-feather="chevron-right"></i>
                                ...
                                @if(\Auth::user()->show_crm() == 1)
                                    @can('show crm dashboard')
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $crmActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('CRM') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                @endphp
                                                <li class="dash-item dash-hasmenu {{ $crmReportsActive ? 'active dash-trigger' : '' }}">
                                                    <a class="dash-link" href="#">
                                                        {{ __('Reports') }}
                                                        <span class="dash-arrow">
                                                            <i data-feather="chevron-right"></i>
                                ...
                                @if(\Auth::user()->show_pos() == 1)
                                    @can('show pos dashboard')
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $posActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('POS') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                @endphp
                                                <li class="dash-item dash-hasmenu {{ $posReportsActive ? 'active dash-trigger' : '' }}">
                                                    <a class="dash-link" href="#">
                                                        {{ __('Reports') }}
                                                        <span class="dash-arrow">
                                                            <i data-feather="chevron-right"></i>
                    ...
                    @if(\Auth::user()->type != 'super admin' && (Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage client')))
                        ...
                        @endphp
                        <li class="dash-item dash-hasmenu {{ $userManagementActive ? 'active dash-trigger' : '' }}">
                            <a href="#!" class="dash-link">
                                <span class="dash-micon">
                            ...
                            <li class="dash-item dash-hasmenu {{ $reportActive ? 'active dash-trigger' : '' }}">
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if(Gate::check('manage set salary') || Gate::check('manage pay slip'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $payrollActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Payroll Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                    ...
                                    @if(Gate::check('manage leave') || Gate::check('manage attendance'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $leaveActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Leave Management Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                                </span>
                                            </a>
                                            <ul class="dash-submenu">
                                                ...
                                                @can('manage attendance')
                                                    ...
                                                    @endphp
                                                    <li class="dash-item dash-hasmenu {{ $attendanceActive ? 'active dash-trigger' : '' }}">
                                                        <a class="dash-link" href="#">
                                                            {{ __('Attendance') }}
                                                            <span class="dash-arrow">
                                                                <i data-feather="chevron-right"></i>
                    ...
                    @if(\Auth::user()->show_hrm() == 1)
                        @if(Gate::check('manage employee') || Gate::check('manage setsalary'))
                            ...
                            @endphp
                            <li class="dash-item dash-hasmenu {{ $hrmSystemActive ? 'active dash-trigger' : '' }}">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                        <i class="ti ti-user"></i>
                                    </span>
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if(Gate::check('manage set salary') || Gate::check('manage pay slip'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $hrmPayrollActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Payroll Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                    ...
                                    @if(Gate::check('manage leave') || Gate::check('manage attendance'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $hrmLeaveActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Leave Management Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                @can('manage attendance')
                                                    ...
                                                    @endphp
                                                    <li class="dash-item dash-hasmenu {{ $hrmAttendanceActive ? 'active dash-trigger' : '' }}">
                                                        <a class="dash-link" href="#">
                                                            {{ __('Attendance') }}
                                                            <span class="dash-arrow">
                                                                <i data-feather="chevron-right"></i>
                                    ...
                                    @if(Gate::check('manage indicator') || Gate::check('manage appraisal') || Gate::check('manage goal tracking'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $performanceActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Performance Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                                </span>
                                            </a>
                                    ...
                                    @if(Gate::check('manage training') || Gate::check('manage trainer') || Gate::check('show training'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $trainingActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Training Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                    ...
                                    @if(Gate::check('manage job') || Gate::check('create job') || Gate::check('manage job application') || Gate::check('manage custom question') || Gate::check('show interview schedule') || Gate::check('show career'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $recruitmentActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Recruitment Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                                </span>
                                            </a>
                                            <ul class="dash-submenu">
                                                @can('manage job')
                                                    ...
                                                    @endphp
                                                    <li class="dash-item {{ $jobActive ? 'active' : '' }}">
                                    ...
                                    @if(Gate::check('manage award') || Gate::check('manage transfer') || Gate::check('manage resignation') || Gate::check('manage travel') || Gate::check('manage promotion') || Gate::check('manage complaint') || Gate::check('manage warning') || Gate::check('manage termination') || Gate::check('manage announcement') || Gate::check('manage holiday'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $hrAdminActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('HR Admin Setup') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                    ...
                                    @if(\Auth::user()->type == 'company' || \Auth::user()->type == 'HR')
                                        ...
                                        @endphp
                                        <li class="dash-item {{ $hrmSetupActive ? 'active dash-trigger' : '' }}">
                    ...
                    @endphp
                    <li class="dash-item dash-hasmenu {{ $quotationActive ? 'active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon">
                                <i class="ti ti-file-invoice"></i>
                            </span>
                            <span class="dash-mtext">{{ __('Quotation System') }}</span>
                            <span class="dash-arrow">
                                <i data-feather="chevron-right"></i>
                            </span>
                        </a>
                        <ul class="dash-submenu">
                            <li class="dash-item {{ (Request::route()->getName() == 'quotation.create') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('quotation.create') }}">
                                    {{ __('Add Quotation') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'quotation.index' || Request::segment(1) == 'quotations') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('quotation.index') }}">
                                    {{ __('Quotation List') }}
                                </a>
                            </li>
                        </ul>
                    ...
                    @endphp
                    <li class="dash-item dash-hasmenu {{ $itemsActive ? 'active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon">
                                <i class="ti ti-package"></i>
                            </span>
                            <span class="dash-mtext">{{ __('Items Management') }}</span>
                            <span class="dash-arrow">
                                <i data-feather="chevron-right"></i>
                            </span>
                        </a>
                        <ul class="dash-submenu">
                            <li class="dash-item {{ (Request::route()->getName() == 'items.create') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('items.create') }}">
                                    <i class="ti ti-plus me-2"></i>
                                    {{ __('Add Items') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'items.index' || Request::segment(1) == 'items') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('items.index') }}">
                                    <i class="ti ti-list me-2"></i>
                                    {{ __('Items List') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'brands.create') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('brands.create') }}">
                                    <i class="ti ti-plus me-2"></i>
                                    {{ __('Add Brand') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'brands.index' || Request::segment(1) == 'brands') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('brands.index') }}">
                                    <i class="ti ti-list me-2"></i>
                                    {{ __('Brand List') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'categories.create') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('categories.create') }}">
                                    <i class="ti ti-plus me-2"></i>
                                    {{ __('Add Category') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'categories.index' || Request::segment(1) == 'categories') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('categories.index') }}">
                                    <i class="ti ti-list me-2"></i>
                                    {{ __('Category List') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'item-variants.create') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('item-variants.create') }}">
                                    <i class="ti ti-plus me-2"></i>
                                    {{ __('Add Variant') }}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'item-variants.index' || Request::segment(1) == 'item-variants') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('item-variants.index') }}">
                                    <i class="ti ti-list me-2"></i>
                                    {{ __('Variants List') }}
                                </a>
                            </li>
                    ...
                    @if(\Auth::user()->show_account() == 1)
                        @if(Gate::check('manage customer') || Gate::check('manage vender') || Gate::check('manage proposal') || Gate::check('manage bank account') || Gate::check('manage bank transfer') || Gate::check('manage invoice') || Gate::check('manage revenue') || Gate::check('manage credit note') || Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note') || Gate::check('manage chart of account') || Gate::check('manage journal entry') || Gate::check('balance sheet report') || Gate::check('ledger report') || Gate::check('trial balance report'))
                            @php
                                $accountingActive = (
                            ...
                            @endphp
                            <li class="dash-item dash-hasmenu {{ $accountingActive ? 'active dash-trigger' : '' }}">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                        <i class="ti ti-box"></i>
                                    </span>
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if(Gate::check('manage chart of account') || Gate::check('manage journal entry') || Gate::check('balance sheet report') || Gate::check('ledger report') || Gate::check('trial balance report'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $doubleEntryActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                                                {{ __('Double Entry') }}
                                                <span class="dash-arrow">
                                                    <i data-feather="chevron-right"></i>
                                    ...
                                    @if(Gate::check('manage constant tax') || Gate::check('manage constant category') || Gate::check('manage constant unit') || Gate::check('manage constant payment method') || Gate::check('manage constant custom field'))
                                        ...
                                        @endphp
                                        <li class="dash-item {{ $accountingSetupActive ? 'active dash-trigger' : '' }}">
                    ...
                    @if(\Auth::user()->show_crm() == 1)
                        @if(Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder') || Gate::check('manage contract'))
                            ...
                            @endphp
                            <li class="dash-item dash-hasmenu {{ $crmSystemActive ? 'active dash-trigger' : '' }}">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if(Gate::check('manage lead stage') || Gate::check('manage pipeline') || Gate::check('manage source') || Gate::check('manage label') || Gate::check('manage stage'))
                                        ...
                                        @endphp
                                        <li class="dash-item {{ $crmSetupActive ? 'active dash-trigger' : '' }}">
                    ...
                    @if(\Auth::user()->show_project() == 1)
                        @if(Gate::check('manage project'))
                            ...
                            @endphp
                            <li class="dash-item dash-hasmenu {{ $projectSystemActive ? 'active dash-trigger' : '' }}">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                ...
                                <ul class="dash-submenu">
                                    @can('manage project')
                                        ...
                                        @endphp
                                        <li class="dash-item {{ $projectActive ? 'active' : '' }}">
                                    ...
                                    @if(Gate::check('manage project task stage') || Gate::check('manage bug status'))
                                        ...
                                        @endphp
                                        <li class="dash-item dash-hasmenu {{ $projectSetupActive ? 'active dash-trigger' : '' }}">
                                            <a class="dash-link" href="#">
                    ...
                    @if(\Auth::user()->show_pos() == 1)
                        @if(Gate::check('manage warehouse') || Gate::check('manage purchase') || Gate::check('manage pos') || Gate::check('manage print settings'))
                            ...
                            @endphp
                            <li class="dash-item dash-hasmenu {{ $posSystemActive ? 'active dash-trigger' : '' }}">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
                                        <i class="ti ti-layers-difference"></i>
                                    </span>
                    ...
                    @if(\Auth::user()->type != 'super admin')
                        @if(Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage company settings'))
                            ...
                            @endphp
                            <li class="dash-item dash-hasmenu {{ $settingsActive ? 'active dash-trigger' : '' }}">
                                <a href="#!" class="dash-link">
                                    <span class="dash-micon">
