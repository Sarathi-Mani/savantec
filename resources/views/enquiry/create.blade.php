                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control item-description" id="item_description_1" name="items[1][description]" rows="3" placeholder="{{ __('Enter item description...') }}" required>{{ old('items.1.description') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control item-description" id="item_description_${itemCount}" name="items[${itemCount}][description]" rows="3" placeholder="{{ __('Enter item description...') }}" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
