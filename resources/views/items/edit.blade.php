    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('items.update', $item->id) }}" id="itemForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" required 
                                           placeholder="Enter item name" value="{{ old('name', $item->name) }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="item_group" name="item_group" required>
                                        ...
                                        <option value="single" {{ old('item_group', $item->item_group) == 'single' ? 'selected' : '' }}>{{ __('Single') }}</option>
                                        <option value="variants" {{ old('item_group', $item->item_group) == 'variants' ? 'selected' : '' }}>{{ __('Variants') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hsn" name="hsn" 
                                           placeholder="Enter HSN code" value="{{ old('hsn', $item->hsn) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="barcode" name="barcode" 
                                           placeholder="Enter barcode" value="{{ old('barcode', $item->barcode) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sku" name="sku" 
                                           placeholder="Enter SKU" value="{{ old('sku', $item->sku) }}">
                                    @error('sku')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered mb-0 align-middle" id="variantsTable">
                                                ...
                                                <tbody id="variantsTableBody">
                                                    ...
                                                    @if($item->item_group == 'variants' && $item->variants->count() > 0)
                                                        @foreach($item->variants as $index => $variant)
                                                            <tr id="variant_{{ $index + 1 }}" class="variant-row">
                                                                <td>
                                                                    <input type="text" name="variants[{{ $index + 1 }}][name]" 
                                                                           class="form-control form-control-sm variant-input" 
                                                                           placeholder="Variant Name" required
                                                                           value="{{ old('variants.' . ($index + 1) . '.name', $variant->name) }}">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="variants[{{ $index + 1 }}][hsn]" 
                                                                           class="form-control form-control-sm variant-input" 
                                                                           placeholder="Optional"
                                                                           value="{{ old('variants.' . ($index + 1) . '.hsn', $variant->hsn) }}">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="variants[{{ $index + 1 }}][sku]" 
                                                                           class="form-control form-control-sm variant-input" 
                                                                           placeholder="Optional"
                                                                           value="{{ old('variants.' . ($index + 1) . '.sku', $variant->sku) }}">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="variants[{{ $index + 1 }}][barcode]" 
                                                                           class="form-control form-control-sm variant-input" 
                                                                           placeholder="Optional"
                                                                           value="{{ old('variants.' . ($index + 1) . '.barcode', $variant->barcode) }}">
                                                                </td>
                                                                <td>
                                                                    <div class="currency-input-wrapper">
                                                                        <span class="currency-symbol">₹</span>
                                                                        <input type="number" name="variants[{{ $index + 1 }}][price]" 
                                                                               class="form-control form-control-sm variant-input currency-input" 
                                                                               placeholder="0.00" min="0" step="0.01" required
                                                                               value="{{ old('variants.' . ($index + 1) . '.price', $variant->price) }}"
                                                                               onchange="calculateVariantPurchasePrice({{ $index + 1 }})">
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="currency-input-wrapper">
                                                                        <span class="currency-symbol">₹</span>
                                                                        <input type="number" name="variants[{{ $index + 1 }}][purchase_price]" 
                                                                               class="form-control form-control-sm variant-input currency-input" 
                                                                               placeholder="0.00" min="0" step="0.01" required
                                                                               value="{{ old('variants.' . ($index + 1) . '.purchase_price', $variant->purchase_price) }}"
                                                                               onchange="calculateVariantProfitMargin({{ $index + 1 }})">
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="percentage-input-wrapper">
                                                                        <input type="number" name="variants[{{ $index + 1 }}][profit_margin]" 
                                                                               class="form-control form-control-sm variant-input percentage-input" 
                                                                               placeholder="0.00" min="0" step="0.01"
                                                                               value="{{ old('variants.' . ($index + 1) . '.profit_margin', $variant->profit_margin) }}"
                                                                               onchange="calculateVariantSalesPrice({{ $index + 1 }})">
                                                                ...
                                                                <td>
                                                                    <div class="currency-input-wrapper">
                                                                        <span class="currency-symbol">₹</span>
                                                                        <input type="number" name="variants[{{ $index + 1 }}][sales_price]" 
                                                                               class="form-control form-control-sm variant-input currency-input" 
                                                                               placeholder="0.00" min="0" step="0.01" required
                                                                               value="{{ old('variants.' . ($index + 1) . '.sales_price', $variant->sales_price) }}"
                                                                               onchange="calculateVariantProfitMarginFromSales({{ $index + 1 }})">
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="currency-input-wrapper">
                                                                        <span class="currency-symbol">₹</span>
                                                                        <input type="number" name="variants[{{ $index + 1 }}][mrp]" 
                                                                               class="form-control form-control-sm variant-input currency-input" 
                                                                               placeholder="0.00" min="0" step="0.01"
                                                                               value="{{ old('variants.' . ($index + 1) . '.mrp', $variant->mrp) }}">
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type="number" name="variants[{{ $index + 1 }}][opening_stock]" 
                                                                           class="form-control form-control-sm variant-input number-input" 
                                                                           placeholder="0" min="0" step="1"
                                                                           value="{{ old('variants.' . ($index + 1) . '.opening_stock', $variant->opening_stock) }}">
                                                                </td>
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-sm btn-danger variant-delete-btn" onclick="removeVariantRow('variant_{{ $index + 1 }}')" title="Remove">
                                                        ...
                                                        <script>
                                                            document.addEventListener('DOMContentLoaded', function() {
                                                                variantCounter = {{ $item->variants->count() }};
                                                            });
                                                        </script>
                                                    @endif
                                                </tbody>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="brand" name="brand">
                                        ...
                                        @foreach($brands as $key => $brandName)
                                            <option value="{{ $brandName }}" {{ old('brand', $item->brand) == $brandName ? 'selected' : '' }}>
                                                {{ $brandName }}
                                            </option>
                                        @endforeach
                                        <option value="other" {{ (old('brand') == 'other' || (!in_array($item->brand, $brands) && $item->brand)) ? 'selected' : '' }}>
                                            {{ __('Other') }}
                                        </option>
                                    </select>
                                    <input type="text" class="form-control mt-2" id="other_brand" name="other_brand" 
                                           placeholder="Enter other brand" 
                                           value="{{ (!in_array($item->brand, $brands) && $item->brand) ? $item->brand : old('other_brand') }}"
                                           style="{{ (old('brand') == 'other' || (!in_array($item->brand, $brands) && $item->brand)) ? '' : 'display: none;' }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="category" name="category">
                                        ...
                                        @foreach($categories as $key => $categoryName)
                                            <option value="{{ $categoryName }}" {{ old('category', $item->category) == $categoryName ? 'selected' : '' }}>
                                                {{ $categoryName }}
                                            </option>
                                        @endforeach
                                        <option value="other" {{ (old('category') == 'other' || (!in_array($item->category, $categories) && $item->category)) ? 'selected' : '' }}>
                                            {{ __('Other') }}
                                        </option>
                                    </select>
                                    <input type="text" class="form-control mt-2" id="other_category" name="other_category" 
                                           placeholder="Enter other category" 
                                           value="{{ (!in_array($item->category, $categories) && $item->category) ? $item->category : old('other_category') }}"
                                           style="{{ (old('category') == 'other' || (!in_array($item->category, $categories) && $item->category)) ? '' : 'display: none;' }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="company_id" name="company_id" required>
                                        ...
                                        @foreach($companies as $id => $companyName)
                                            <option value="{{ $id }}" {{ old('company_id', $item->company_id) == $id ? 'selected' : '' }}>
                                                {{ $companyName }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="unit" name="unit">
                                        ...
                                        @endforeach
                                        <option value="other" {{ (old('unit') == 'other' || (!in_array($item->unit, array_keys($units)) && $item->unit)) ? 'selected' : '' }}>
                                            {{ __('Other') }}
                                        </option>
                                    </select>
                                    <input type="text" class="form-control mt-2" id="other_unit" name="other_unit" 
                                           placeholder="Enter other unit" 
                                           value="{{ (!in_array($item->unit, array_keys($units)) && $item->unit) ? $item->unit : old('other_unit') }}"
                                           style="{{ (old('unit') == 'other' || (!in_array($item->unit, array_keys($units)) && $item->unit)) ? '' : 'display: none;' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control text-end" id="alert_quantity" 
                                           ...
                                           value="{{ old('alert_quantity', $item->alert_quantity) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control text-end" id="opening_stock" 
                                           ...
                                           value="{{ old('opening_stock', $item->opening_stock) }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control text-end" id="seller_points" 
                                           ...
                                           value="{{ old('seller_points', $item->seller_points) }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="discount_type" name="discount_type">
                                        <option value="percentage" {{ old('discount_type', $item->discount_type) == 'percentage' ? 'selected' : 'selected' }}>
                                            {{ __('Percentage(%)') }}
                                        </option>
                                        <option value="fixed" {{ old('discount_type', $item->discount_type) == 'fixed' ? 'selected' : '' }}>
                                            {{ __('Fixed Amount') }}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="tax_type" name="tax_type" required>
                                        <option value="">{{ __('-Select-') }}</option>
                                        <option value="inclusive" {{ old('tax_type', $item->tax_type) == 'inclusive' ? 'selected' : 'selected' }}>
                                            {{ __('Inclusive') }}
                                        </option>
                                        <option value="exclusive" {{ old('tax_type', $item->tax_type) == 'exclusive' ? 'selected' : '' }}>
                                            {{ __('Exclusive') }}
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="tax_id" name="tax_id">
                                        ...
                                        @foreach($taxes as $tax)
                                            ...
                                            @endphp
                                            <option value="{{ $tax->id }}" 
                                                    {{ old('tax_id', $item->tax_id) == $tax->id ? 'selected' : '' }}
                                                    data-rate="{{ $taxRate }}">
                                                {{ $displayText }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control text-end" id="purchase_price" 
                                               ...
                                               required value="{{ old('purchase_price', $item->purchase_price) }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control text-end" id="sales_price" 
                                               ...
                                               required value="{{ old('sales_price', $item->sales_price) }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control text-end" id="profit_margin" 
                                               ...
                                               value="{{ old('profit_margin', $item->profit_margin) }}">
                                        <span class="input-group-text">%</span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($item->item_image)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('storage/' . $item->item_image) }}" alt="Current Image" style="max-width: 200px; border: 1px solid #ddd; padding: 5px;">
                                ...
                                <div class="form-group">
                                    ...
                                    @if($item->additional_image)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('storage/' . $item->additional_image) }}" alt="Current Additional Image" style="max-width: 200px; border: 1px solid #ddd; padding: 5px;">
                                            <div class="form-check mt-2">
...
<script>
    ...
    let variantCounter = {{ $item->variants->count() }};
    ...
    $(document).ready(function() {
        ...
        @if(!in_array($item->brand, $brands) && $item->brand)
        ...
        @if(!in_array($item->unit, array_keys($units)) && $item->unit)
