                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-5">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <a href="{{ route('brands.index') }}" class="btn btn-secondary px-4 me-2">
                                        ...
                                        <button type="submit" class="btn btn-primary px-4">
                                            <i class="ti ti-check me-1"></i> {{ __('Update Brand') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">{{ __('Delete Brand') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    @if($itemCount > 0)
                        <div class="alert alert-warning mt-3">
                            ...
                            {{ __('This brand is being used in :count items. You cannot delete it until you remove or reassign these items.', ['count' => $itemCount]) }}
                        </div>
                    @endif
                </div>
                <div class="modal-footer">
                    ...
                    @if($itemCount == 0)
                        <form action="{{ route('brands.destroy', $brand->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger">{{ __('Delete Brand') }}</button>
                        </form>
                    @endif
                </div>
            </div>
